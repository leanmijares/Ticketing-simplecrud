     <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                ...
                <span class="mr-2 d-none d-lg-inline text-gray-600 small" style="cursor: pointer; letter-spacing: 1px;"><?=$_SESSION['username'] ?></span></a>
               
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="dropdown">
                <a role="button" class="dropdown-item text-gray-600 small"  data-toggle="modal" data-target="#logoutModal" style="cursor: pointer">
